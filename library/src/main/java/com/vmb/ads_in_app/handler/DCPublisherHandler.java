...
public class DCPublisherHandler {
    ...
    public void initBannerPublisher(final Activity activity, final ViewGroup banner_layout,
    ...
    public void initInterstitialDC(final Activity activity, final boolean isShowLoadingScreenOpenApp) {
            ...
            public void onAdLoaded() {
                ...
                if (!AdsHandler.getInstance().isShowPopupOpenApp()) {
                    if (isShowLoadingScreenOpenApp) {
                        ...
                        intent.putExtra(LibrayData.KeyIntentData.KEY_ADS_ACTIVITY, "richadx");
